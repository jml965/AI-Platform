...
const DEFAULT_AGENTS = [
  {
    ...
    primaryModel: { provider: "openai", model: "o3", enabled: true },
    secondaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: false },
    tertiaryModel: { provider: "openai", model: "gpt-4o", enabled: false },
  ...
  },
  {
    ...
    secondaryModel: { provider: "openai", model: "o3", enabled: false },
    tertiaryModel: { provider: "openai", model: "gpt-4o", enabled: false },
  ...
  },
  {
    ...
    primaryModel: { provider: "local", model: "none", enabled: true },
    secondaryModel: null,
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "local", model: "orchestrator", enabled: true },
    secondaryModel: null,
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: true },
    secondaryModel: { provider: "openai", model: "gpt-4o", enabled: false },
    tertiaryModel: null,
  ...
  },
  {
    ...
    primaryModel: { provider: "openai", model: "gpt-4o", enabled: true },
    secondaryModel: { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: false },
    tertiaryModel: null,
...
router.post("/agents/configs", async (req, res) => {
  try {
    ...
    const [created] = await db.insert(agentConfigsTable).values({
      ...
      primaryModel: body.primaryModel || { provider: "anthropic", model: "claude-sonnet-4-20250514", enabled: true },
