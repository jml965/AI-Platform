    ...
    <div className="flex flex-col h-full">
      <div className="px-3 py-2 border-b border-[#1c2333] flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-[#1c2333] text-[#d4dae3]">
            {snapshots.length}
          </span>
        </div>
        <button
          onClick={() => setShowCreateForm((v) => !v)}
          className="p-1 rounded text-[#d4dae3] hover:text-[#58a6ff] hover:bg-[#1c2333] transition-colors"
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-2 py-1.5 text-[#d4dae3] text-xs rounded hover:bg-[#1c2333] transition-colors"
                >
                  {t.cancel}
                </button>
              </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {snapshots.length === 0 ? (
          <div className="text-center mt-8 px-4">
            ...
            <p className="text-xs text-[#d4dae3]">{t.snapshot_no_snapshots}</p>
          </div>
        ) : (
                  ...
                  <div className="flex items-start gap-2">
                    <div className="mt-0.5">
                      {expandedSnapshotId === snap.id ? (
                        ...
                        <ChevronRight className="w-3 h-3 text-[#d4dae3]" />
                      )}
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      {snap.description && (
                        <p className="text-[10px] text-[#d4dae3] truncate mt-0.5">
                          {snap.description}
                        </p>
                      )}
                          ...
                          <div className="bg-[#0d1117] border border-[#30363d] rounded p-2">
                            ...
                            <div className="flex gap-1.5">
                              ...
                              <button
                                ...
                                className="px-2 py-1 text-[11px] text-[#d4dae3] rounded hover:bg-[#1c2333] transition-colors"
                              >
                                <X className="w-3 h-3" />
                              </button>
                            </div>
                            ...
                            <button
                              ...
                              className={cn(
                                ...
                                comparingSnapshotId === snap.id
                                  ...
                                  : "text-[#d4dae3] bg-[#1c2333] hover:bg-[#21262d]"
                              )}
                            >
                            ...
                            >
                              <div className="bg-[#0d1117] border border-[#30363d] rounded p-2 space-y-2 mt-1">
                                ...
                                {typedCompareData.added.length > 0 && (
                                  <div>
                                    ...
                                    {typedCompareData.added.map((f) => (
                                      <p key={f} className="text-[10px] text-[#d4dae3] ps-4 truncate">{f}</p>
                                    ))}
                                  </div>
                                )}
                                ...
                                {typedCompareData.modified.length > 0 && (
                                  <div>
                                    ...
                                    {typedCompareData.modified.map((f) => (
                                      <p key={f.filePath} className="text-[10px] text-[#d4dae3] ps-4 truncate">
                                        {f.filePath}
                                      </p>
                                    ))}
                                  </div>
                                ...
                                {typedCompareData.added.length === 0 &&
                                  typedCompareData.removed.length === 0 &&
                                  typedCompareData.modified.length === 0 && (
                                    <p className="text-[10px] text-[#d4dae3]">
