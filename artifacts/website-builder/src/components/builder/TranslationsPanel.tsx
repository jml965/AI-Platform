  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117] text-[#e1e4e8]">
      <div className="px-4 py-3 border-b border-[#1c2333]">
        ...
        <p className="text-xs text-[#d4dae3]">{t.translations_desc}</p>
      </div>

      <div className="px-4 py-3 border-b border-[#1c2333]">
        <div className="flex items-center justify-between mb-2">
          <span className="text-xs font-medium text-[#d4dae3] uppercase tracking-wider">
        ...
        {projectLanguages.length === 0 ? (
          <p className="text-xs text-[#d4dae3] py-4 text-center">
      ...
      {selectedLang && (
        <div className="flex-1 overflow-y-auto">
          <div className="px-4 py-2 border-b border-[#1c2333] flex items-center justify-between sticky top-0 bg-[#0d1117] z-10">
            <span className="text-xs font-medium text-[#d4dae3]">
          ...
          {translationsList.length === 0 ? (
            <p className="text-xs text-[#d4dae3] py-8 text-center px-4">
              ...
              {translationsList.map((tr) => (
                <div key={tr.id} className="px-4 py-3">
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    <span className="text-[10px] text-[#d4dae3] font-mono truncate max-w-[200px]">
                  ...
                  <div className="mb-1.5">
                    <span className="text-[10px] text-[#d4dae3] block mb-0.5">
                    ...
                    {editingId === tr.id ? (
                      <div className="flex gap-1.5">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <button
                            ...
                            className="p-1 text-[#d4dae3] hover:bg-[#1c2333] rounded transition-colors"
                          >
                      ...
                      <div className="flex items-start gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1 text-[#d4dae3] hover:text-[#e1e4e8] hover:bg-[#1c2333] rounded transition-colors flex-shrink-0"
                        >
