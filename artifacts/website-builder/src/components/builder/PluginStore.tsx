            ...
            <button
              ...
              className={cn(
                ...
                selectedCategory === cat
                  ...
                  : "bg-[#161b22] text-[#d4dae3] hover:text-[#e1e4e8] hover:bg-[#1c2333]"
              )}
            >
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-[#1c2333] text-[#d4dae3] flex-shrink-0">
                      {(t as Record<string, string>)[`plugin_category_${plugin.category}`] || plugin.category}
                    </span>
                  </div>
                  <p className="text-[10px] text-[#d4dae3] mt-0.5 line-clamp-2 leading-relaxed">{desc}</p>
                </div>
              </div>
              ...
              <div className="flex gap-1.5 mt-2">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 px-2 py-1 text-[10px] font-medium rounded-md bg-[#0d1117] text-[#d4dae3] hover:text-[#e1e4e8] hover:bg-[#1c2333] transition-colors"
                >
