  ...
  return (
    <div className="h-full flex flex-col bg-[#0d1117]">
      <div className="p-4 border-b border-[#1c2333]">
        ...
        <p className="text-[11px] text-[#d4dae3]">{t.seo_description}</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {isAnalyzing && (
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <p className="text-sm text-[#d4dae3]">{t.seo_analyzing}</p>
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex gap-3">
              <div className="flex-1 bg-[#161b22] border border-[#1c2333] rounded-lg p-3 text-center">
                ...
                <span className="text-[10px] text-[#d4dae3]">{t.seo_passed}</span>
              </div>
              <div className="flex-1 bg-[#161b22] border border-[#1c2333] rounded-lg p-3 text-center">
                ...
                <span className="text-[10px] text-[#d4dae3]">{t.seo_failed}</span>
              </div>
            </div>
                            ...
                            {checks.map((check: SeoCheckItem, idx: number) => (
                              <div key={idx} className="flex gap-2 items-start">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <p className="text-[10px] text-[#d4dae3] mt-0.5">
