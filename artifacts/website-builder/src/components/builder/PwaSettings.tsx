    ...
    <div className="p-4 space-y-4 overflow-y-auto max-h-[calc(100vh-200px)]">
      ...
      <label className="flex items-center justify-between p-3 bg-[#161b22] border border-[#30363d] rounded-lg cursor-pointer hover:border-[#58a6ff]/50 transition-colors">
        <div className="flex-1">
          ...
          <p className="text-[11px] text-[#d4dae3] mt-0.5">{t.pwa_enable_desc}</p>
        </div>
        <div
      ...
      {form.enabled && (
        <>
          <div className="space-y-3">
            <div>
              <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_app_name}</label>
              <input
                type="text"
                value={form.appName}
            ...
            <div>
              <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_short_name}</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_description}</label>
              <textarea
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_theme_color}</label>
              ...
              <div>
                <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_bg_color}</label>
                <div className="flex items-center gap-2">
                  <input
                    type="color"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_display}</label>
                <select
                  value={form.display}
              ...
              <div>
                <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_orientation}</label>
                <select
            ...
            <div>
              <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_icon_url}</label>
              <input
                type="text"
                value={form.iconUrl}
            ...
            <div>
              <label className="text-[11px] font-medium text-[#d4dae3] mb-1 block">{t.pwa_start_url}</label>
              <input
                type="text"
                value={form.startUrl}
            ...
            <label className="flex items-center justify-between p-3 bg-[#161b22] border border-[#30363d] rounded-lg cursor-pointer hover:border-[#58a6ff]/50 transition-colors">
              <div className="flex items-center gap-2">
                {form.offlineEnabled ? (
                  ...
                  <Wifi className="w-4 h-4 text-[#d4dae3]" />
                )}
                <div>
                  <p className="text-[13px] font-medium text-[#e1e4e8]">{t.pwa_offline}</p>
                  <p className="text-[11px] text-[#d4dae3]">{t.pwa_offline_desc}</p>
                </div>
              </div>
              <div
          ...
          <div className="space-y-2 p-3 bg-[#161b22] border border-[#30363d] rounded-lg">
            <div className="flex items-center justify-between">
              <span className="text-[11px] text-[#d4dae3]">{t.pwa_manifest_url}</span>
              <button
                onClick={() => copyToClipboard(manifestUrl)}
                className="p-1 text-[#d4dae3] hover:text-[#e1e4e8] transition-colors"
              >
            ...
            <div className="flex items-center justify-between mt-2">
              <span className="text-[11px] text-[#d4dae3]">{t.pwa_sw_url}</span>
              <button
