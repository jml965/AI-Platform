...
export default function DomainSettings({ projectId }: DomainSettingsProps) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default: return "text-[#d4dae3] bg-[#d4dae3]/10";
    }
  };
    ...
    <div className="p-4 space-y-4">
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-8">
          <Loader2 className="w-5 h-5 animate-spin text-[#d4dae3]" />
        </div>
      )}

      {!isLoading && domains.length === 0 && (
        <div className="text-center py-8 text-[#d4dae3] text-sm">
          {t.domain_no_domains}
        </div>
      )}
          ...
          <div key={domain.id} className="bg-[#161b22] border border-[#1c2333] rounded-lg p-3 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Globe className="w-4 h-4 text-[#d4dae3]" />
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-1.5 text-[#d4dae3] hover:text-[#58a6ff] hover:bg-[#1c2333] rounded transition-colors"
                ...
                <button
                  ...
                  className="p-1.5 text-[#d4dae3] hover:text-red-400 hover:bg-red-400/10 rounded transition-colors"
            ...
            <div className="flex items-center gap-4 text-[11px]">
              ...
              <span className={cn("flex items-center gap-1", domain.sslIssued ? "text-emerald-400" : "text-[#d4dae3]")}>
...
function DnsRecordRow({
  ...
  return (
    <div className="space-y-1">
      <p className="text-[11px] text-[#d4dae3]">{label}</p>
      <div className="grid grid-cols-3 gap-2 text-[11px]">
        ...
        <div className="bg-[#161b22] rounded px-2 py-1.5 flex items-center justify-between gap-1">
          ...
          <button
            ...
            className="p-1 text-[#d4dae3] hover:text-[#e1e4e8] transition-colors flex-shrink-0"
          >
