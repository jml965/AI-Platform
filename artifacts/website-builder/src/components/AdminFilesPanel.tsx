...
function getFileIcon(name: string) {
  ...
  return <File className="w-3.5 h-3.5 text-[#d4dae3] flex-shrink-0" />;
}
        ...
        >
          ...
          >
            {isExpanded ? (
              ...
              <ChevronRight className="w-3 h-3 text-[#d4dae3] flex-shrink-0" />
            )}
            {isExpanded ? (
              <FolderOpen className="w-3.5 h-3.5 text-[#e3b341] flex-shrink-0" />
            ) : (
              <Folder className="w-3.5 h-3.5 text-[#d4dae3] flex-shrink-0" />
            )}
            {isRenaming ? (
              <InlineInput
          ...
          <button
            ...
            className="opacity-0 group-hover:opacity-100 p-0.5 mr-1 rounded hover:bg-white/10 text-[#d4dae3] hover:text-white transition-all flex-shrink-0"
          >
            ...
            {creatingIn === fullPath && creatingType && (
              <div className="flex items-center gap-1 px-1 py-[3px]" style={{ paddingLeft: `${(depth + 1) * 12 + 20}px` }}>
                {creatingType === "folder" ? (
                  ...
                  <File className="w-3.5 h-3.5 text-[#d4dae3] flex-shrink-0" />
                )}
                <InlineInput
                  defaultValue=""
  ...
  return (
    <div className="flex flex-col h-full bg-[#0d1117]">
        ...
        <div className="flex items-center gap-1 flex-shrink-0">
          {canEdit && !editing && (
            <button
              ...
              className="p-1 rounded hover:bg-white/10 text-[#d4dae3] hover:text-white transition-colors"
              title="Edit"
            >
      ...
      <div className="flex-1 overflow-auto">
        {loading && <div className="text-[#d4dae3] text-[12px] animate-pulse p-3">Loading...</div>}
    ...
    <div className="flex flex-col h-full bg-[#0d1117]">
      ...
      <div className="flex items-center justify-between px-3 py-2.5 flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onClose}
            className="flex items-center gap-1 text-[11px] text-[#d4dae3] hover:text-[#c9d1d9] transition-colors"
          >
          ...
          <div className="relative">
            <button
              ...
              className="text-[#d4dae3] hover:text-[#c9d1d9] transition-colors p-0.5"
            >
      ...
      <div className="px-2 pb-2 flex-shrink-0">
        <div className="flex items-center gap-1.5 bg-white/5 border border-white/7 rounded-md px-2.5 py-1.5">
          ...
          />
          {searchTerm && (
            <button onClick={() => setSearchTerm("")} className="text-[#d4dae3] hover:text-white">
              <X className="w-3 h-3" />
            </button>
          )}
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-1 pb-2">
          {loading ? (
            <div className="flex items-center justify-center py-8">
              <RefreshCw className="w-4 h-4 text-[#d4dae3] animate-spin" />
            </div>
          ) : tree.length === 0 ? (
            <div className="text-[#d4dae3] text-[12px] text-center py-8">No files found</div>
          ) : (
            tree.map((node, i) => (
              <TreeNodeItem
                key={node.name + i}
