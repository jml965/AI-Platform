...
export const agentConfigsTable = pgTable("agent_configs", {
  ...
  primaryModel: jsonb("primary_model").$type<{ provider: string; model: string; enabled: boolean }>().notNull(),
  secondaryModel: jsonb("secondary_model").$type<{ provider: string; model: string; enabled: boolean }>(),
  tertiaryModel: jsonb("tertiary_model").$type<{ provider: string; model: string; enabled: boolean }>(),
